...
export class GraphicsParser extends Parser {
	...
	public static readonly VOCABULARY: Vocabulary = new VocabularyImpl(GraphicsParser._LITERAL_NAMES, GraphicsParser._SYMBOLIC_NAMES, []);
	...
	// @Override
	public get ruleNames(): string[] { return GraphicsParser.ruleNames; }

	// @Override
	public get serializedATN(): string { return GraphicsParser._serializedATN; }
	...
	public static get _ATN(): ATN {
		if (!GraphicsParser.__ATN) {
			GraphicsParser.__ATN = new ATNDeserializer().deserialize(Utils.toCharArray(GraphicsParser._serializedATN));
		}
...
export class FileContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return GraphicsParser.RULE_file; }
	// @Override
...
export class CommandContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return GraphicsParser.RULE_command; }
	// @Override
	public enterRule(listener: GraphicsListener): void {
...
export class PointContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return GraphicsParser.RULE_point; }
	// @Override
	public enterRule(listener: GraphicsListener): void {
